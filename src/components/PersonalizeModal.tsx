            ...
            <div className="space-y-5 animate-in fade-in duration-200">
              ...
              <div className="p-5 rounded-2xl bg-gradient-to-br from-slate-900 to-indigo-950 text-white shadow-md space-y-4 border border-indigo-900/50">
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                  ...
                  <a
                    href="https://good0211v2.github.io"
                    target="_blank"
                ...
                <div className="space-y-3 text-xs text-slate-300 leading-relaxed">
                  <p className="font-semibold text-white flex items-center gap-1.5">
                    ...
                    How to make this project appear on Good0211V2.github.io:
                  </p>
                  <ol className="list-decimal list-inside space-y-1 pl-1 text-slate-300 text-[11px]">
                    <li>
                      Create a repository on your GitHub account named exactly <strong className="text-white font-mono bg-white/10 px-1 py-0.5 rounded">Good0211V2.github.io</strong> (public).
                    </li>
                    <li>
                  ...
                  <div className="relative p-3 bg-slate-950/90 rounded-xl border border-white/15 font-mono text-[11px] text-slate-300 overflow-x-auto">
                    <button
                      type="button"
                      onClick={() => {
                        const commands = `git init\ngit add .\ngit commit -m "Deploy Romantic Sanctuary to Good0211V2.github.io"\ngit branch -M main\ngit remote add origin https://github.com/Good0211V2/Good0211V2.github.io.git\ngit push -u origin main --force`;
                    ...
                    <div className="space-y-1 text-slate-300 pr-36 select-all">
                      ...
                      <div>git init</div>
                      <div>git add .</div>
                      <div>git commit -m "Deploy Romantic Sanctuary to Good0211V2.github.io"</div>
                      <div className="text-slate-500 pt-1"># 2. Link your Good0211V2.github.io repository</div>
                      <div>git branch -M main</div>
                      <div>git remote add origin https://github.com/Good0211V2/Good0211V2.github.io.git</div>
        ...
        run: |
          if [ -f "package.json" ]; then
            ...
            if [ -n "\$FOUND" ]; then
              ...
              echo "Project found in subfolder: \$DIR"
            else
              echo "::error::No package.json found! Please upload project files to your repository."
              exit 1
            fi
          fi
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="e.g. Good0211V2.github.io"
                      className="w-full px-3 py-2 text-xs bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-slate-900 outline-none"
                    />
                  </div>
