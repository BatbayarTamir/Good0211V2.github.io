...
export function getGitHubConfig(): GitHubConfig {
  ...
  const envOwner = (import.meta.env.VITE_GITHUB_OWNER as string | undefined) || 'Good0211V2';
  const envRepo = (import.meta.env.VITE_GITHUB_REPO as string | undefined) || 'Good0211V2.github.io';
  ...
  const owner = (localConfig.owner ?? envOwner).trim() || 'Good0211V2';
  const repo = (localConfig.repo ?? envRepo).trim() || 'Good0211V2.github.io';
